...
export default function BreathingGuide({
    ...
    const Controls = (
        <>
            ...
            <div className="fixed bottom-[3%] left-1/2 -translate-x-1/2 ml-5 flex items-center justify-center gap-8 w-full max-w-lg px-4 z-40 pointer-events-auto">
        ...
        <div className="relative flex flex-col items-center justify-center w-full max-w-md mx-auto p-6">
            ...
            <div className="relative flex items-center justify-center w-64 h-64 mb-12">
                ...
                <motion.div
                    ...
                    className={`w-40 h-40 rounded-full backdrop-blur-sm border border-white/20 shadow-[0_0_40px_rgba(255,255,255,0.2)] flex items-center justify-center ${circleColor}`}
                >
                    {centerContent}
                </motion.div>
